...
@Component
public class GradeByFailuresIndexManager {

    private final ElasticsearchClient es;

    public GradeByFailuresIndexManager(ElasticsearchClient es) {
        this.es = es;
    }

    public String indexName(String prefix) {

        return prefix + "v_grade_by_failures";
    ...
    public void ensureIndexExists(String indexName) throws IOException {
        ...
        es.indices().create(CreateIndexRequest.of(b -> b
                ...
                .mappings(m -> m
                        ...
                        .properties("failures", p -> p.integer(i -> i))
