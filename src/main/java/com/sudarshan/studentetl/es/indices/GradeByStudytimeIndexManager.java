...
@Component
public class GradeByStudytimeIndexManager {

    private final ElasticsearchClient es;


    public GradeByStudytimeIndexManager(ElasticsearchClient es) {
        this.es = es;
    }

    public String indexName(String prefix) {
        return prefix + "v_grade_by_studytime";
    }
    ...
    public void ensureIndexExists(String indexName) throws IOException {
        ...
        es.indices().create(CreateIndexRequest.of(b -> b
                ...
                .mappings(m -> m
                        ...
                        .properties("studytime", p -> p.integer(i -> i))
