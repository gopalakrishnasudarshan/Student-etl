...
@Service
public class GradeBySexExporter {

    private static final String VIEW_NAME = "v_grade_by_sex";

    private final JdbcTemplate jdbcTemplate;
    private final ElasticsearchClient es;

    public GradeBySexExporter(JdbcTemplate jdbcTemplate, ElasticsearchClient es) {
    ...
    public long export(String indexName, String exportRunId, long etlRunId) throws IOException {
        ...
        for (Map<String, Object> r : rows) {
            ...
            String sex = (String) r.get("sex");

            String id = subject + "|" + sex;
